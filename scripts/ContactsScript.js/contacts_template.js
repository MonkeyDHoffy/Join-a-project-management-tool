                    ...
                    <div class="input-and-close-wrapper">
                      ...
                      <div class="input-group">
                          <div class="contact-form">
                              ...
                              <input type="text" id="name" placeholder="Name" class="contact-input">
                              ...
                              <input type="tel" id="phone" placeholder="Phone" class="contact-input">
                              <img class="input-icon" src="./assets/img/contacts_imgs/call.png" alt="Phone Icon">
                          </div>
                          
                  </div>
                          <div class="button-group">
                              <button onclick="hideOverlay()" class="cancel-btn-overlay">Cancel <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.06917 7.00008L12.3122 12.2431M1.82617 12.2431L7.06917 7.00008L1.82617 12.2431ZM12.3122 1.75708L7.06817 7.00008L12.3122 1.75708ZM7.06817 7.00008L1.82617 1.75708L7.06817 7.00008Z" stroke="#2A3647" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
