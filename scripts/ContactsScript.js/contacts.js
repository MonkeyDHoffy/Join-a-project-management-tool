                ...
                <div class="content-overlay-right">
                    ...
                    <div class="input-group">
                        ...
                        <div class="button-group">
                            ...
                            <button onclick="hideOverlay(); showClickNotification();" class="create-btn-overlay">Create contact ✓</button>
                        </div>
                    </div>
                </div>
  ...
  contactItem.innerHTML += ` <div class="slider"><div class="pic-and-name">
                                ...
                                <div class="name-and-edit">
                                    ...
                                    <div class="edit-delete-btn">
                                        <div onclick="renderEditOverlay()" class="edit-btn"><svg width="24" height="24" viewBox="0 0 24 24"
